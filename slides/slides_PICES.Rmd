...
Factor on $r^{\star}_{jurel}$ under SSP5-8.5 end-of-century, combining 16k posterior draws with 6-GCM ensemble of $\Delta\widetilde{\text{ENSO}}$ ($+3.65 \pm 0.88\,^{\circ}$C):
...
.tldr[<b style="color:#c4830a;">&rarr;</b> Climate effects on jurel operate on *margins* (location, behaviour, range) &mdash; **not** on annual productivity elasticity at this aggregation. @Pe&ntilde;a-Torres 2017, @Arcos 2001, @Espinoza 2013.]
