...
## Biomass affects **quota allocation**  

Quota allocated vary across **vessels** $\times$ **years** (sector and regional TAC moves conditional on biomass; vessel share fixed). Reduced-form mapping.
]
...
<span class="small-note">Negative binomial, vessel-clustered robust SEs. Sign and significance shown. <sup>***</sup> $p < 0.01$. <sup style="color:#c4830a;">&dagger;</sup> zone-FE collinear (not causally interpretable).</span>
