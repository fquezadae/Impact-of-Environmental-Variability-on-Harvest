...
.tldr[Two fleets, **completely different participation models**. Same regulatory variables, opposite signs.]
...
- IND's protection partly rests on jack mackerel &mdash; whose long-run shifter is **n.i.** (deferred).
]
...
with $X_{vg}=[w; h_{vg}; x; Z_v; Env]$, $g \in \{\text{ART, IND}\}$. SUR per fleet.
