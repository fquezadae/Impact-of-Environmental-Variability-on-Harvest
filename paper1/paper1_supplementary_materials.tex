...
proportionally smaller change in realised artisanal landings. Cession
contracts under the inter-sectoral channel are bilateral agreements
between LTP-holders and RPA-holders and do not carry a fiscal levy
per tonne transferred under either the pre-reform or the 2025-reform
regime; the binding margin of the institutional re-allocation
therefore remains the de jure fractioning combined with the realised
cession quotas documented in Tables \ref{tab:cesiones-anchsard} and
\ref{tab:cesiones-jurel}.
