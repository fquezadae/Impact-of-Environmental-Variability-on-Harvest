...
anchoveta and sardine fisheries the industrial sector cedes the
...
operators ranges from \(85\%\) to \(99\%\) in \(2019\)--\(2024\); the
format-heterogeneous per-titular \(2013\)--\(2017\) records are not directly
comparable and are summarised qualitatively in the table notes. The cession volume scales with the TAC and
...
\begin{table}[H]
\centering
\caption{Inter-sectoral cession flow, Central-South small pelagic fishery, $2013$--$2024$. Source:
...
the $2019$--$2024$ reports, in a per-titular CSV format, and is parsed analogously to the workbook series. Source workbooks for $2013$--$2017$ use a
