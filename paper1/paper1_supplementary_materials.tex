...
\caption{Permit-portfolio breadth indicators by sector bucket, Chile small pelagic logbook $2001$--$2024$ (artisanal) and SUBPESCA $2012$ registry (industrial).\label{tab:portfolio-descriptive}}
\begin{threeparttable}
\begin{tabular}{lrrrrr}
\toprule
Bucket & $n$ vessels & Sp.\ lifetime & Multi-sp.\ lifetime (\%) & Sp.\ per year & Multi-sp.\ per year (\%) \\
\midrule
...
\item \emph{Notes.} IND row: SUBPESCA $2012$ registry ($1{,}149$ authorisations across $299$ vessels; $75.6\%$ hold the full anchoveta--sardine--jack mackerel triplet, $67.6\%$ are authorised in $\geq 2$ macrozones). Artisanal rows: $2001$--$2024$ IFOP scientific-observer logbook, lances with valid species codes. Buckets follow the IFOP $2016$ typology used in the main text: LM = \emph{Lancha a Motor}, BM = \emph{Bote a Motor}, industrial reported as PAM; LM and BM separate empirically by hold capacity (median $64$ vs $4$~m\textsuperscript{3}, non-overlapping IQRs). The anchoveta--sardine--jack mackerel triplet accounts for $80$--$86\%$ of artisanal and $67\%$ of industrial lances.
\end{tablenotes}
\end{threeparttable}
\end{table}
