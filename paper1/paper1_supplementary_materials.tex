...
on the post-cession allocation.
...
reflects the post-cession allocation produced by the joint pre-reform
...
be read as a de jure upper bound on the post-cession allocation:
...
between LTP-holders and RPA-holders subject to ex-ante SUBPESCA
authorisation. The post-cession allocation therefore depends on the
de jure fractioning combined with the realised cession flows
documented in Tables \ref{tab:cesiones-anchsard} and
\ref{tab:cesiones-jurel}.
