...
\noindent\textit{Convergence diagnostics table not yet built.  Run \texttt{Rscript R/08\_stan\_t4/08\_fit\_t4b\_full.R} to generate  \texttt{data/outputs/t4b/t4b\_full\_summary.csv}, then re-knit.}
...
series (the \(2018\)--\(2024\) subperiod is reported in
Table \ref{tab:cesiones-evidence}). First, in the
anchoveta and sardine fisheries the industrial sector cedes a large
share of its assigned TAC to artisanal cessionaries: the share of the
industrial assignment transferred to artisanal operators ranges from
\(85\%\) to \(99\%\) in \(2019\)--\(2024\) and from \(12\%\) to \(72\%\) across the
\(2013\)--\(2017\) industrial quota-control workbooks. The cession volume scales with the TAC and
ranges from \(26\) to \(50\) kt per year in anchoveta and from \(51\) to
\(77\) kt per year in sardine. Second, in the jack mackerel fishery the
...
\begin{table}[H]
\centering
\caption{Inter-sectoral cession flow, Central-South small pelagic fishery, $2018$--$2024$. Source:
...
2018 & sardine & 74.2 & $-63.2$ & 85\% & IND$\rightarrow$ART \\
2018 & jack mackerel & 326.9 & $+16.1$ & 5\% & ART$\rightarrow$IND \\
2019 & anchoveta & 27.4 & $-25.8$ & 94\% & IND$\rightarrow$ART \\
2019 & sardine & 76.0 & $-69.6$ & 92\% & IND$\rightarrow$ART \\
2019 & jack mackerel & 339.0 & $+12.0$ & 3\% & ART$\rightarrow$IND \\
2020 & anchoveta & 38.6 & $-33.3$ & 86\% & IND$\rightarrow$ART \\
2020 & sardine & 67.2 & $-60.9$ & 91\% & IND$\rightarrow$ART \\
2020 & jack mackerel &1268.1 & $+11.8$ & 1\% & ART$\rightarrow$IND \\
2021 & anchoveta & 45.3 & $-45.1$ &$\sim\!100\%$ & IND$\rightarrow$ART \\
2021 & sardine & 76.9 & $-76.5$ &$\sim\!100\%$ & IND$\rightarrow$ART \\
2021 & jack mackerel & 448.7 & $+13.3$ & 3\% & ART$\rightarrow$IND \\
2022 & anchoveta & 52.2 & $-50.5$ & 97\% & IND$\rightarrow$ART \\
2022 & sardine & 77.7 & $-71.6$ & 92\% & IND$\rightarrow$ART \\
2022 & jack mackerel & 516.4 & $+15.2$ & 3\% & ART$\rightarrow$IND \\
2023 & anchoveta & 39.9 & $-37.1$ & 93\% & IND$\rightarrow$ART \\
2023 & sardine & 63.3 & $-61.7$ & 98\% & IND$\rightarrow$ART \\
2023 & jack mackerel & 637.0 & $-0.7$ & 0\% & IND$\rightarrow$ART \\
2024 & anchoveta & 53.8 & $-45.5$ & 85\% & IND$\rightarrow$ART \\
2024 & sardine & 53.9 & $-51.0$ & 95\% & IND$\rightarrow$ART \\
2024 & jack mackerel & 728.6 & $-31.5$ & 4\% & IND$\rightarrow$ART \\
\bottomrule
\end{tabular}
\begin{tablenotes}[flushleft]\footnotesize
...
sardine: Valparaíso--Los Lagos; jack mackerel: Arica y Parinacota--Los Lagos). ``IND cession''
...
industrial-to-artisanal flows, positive values
denote the reverse direction. ``Share ceded'' is the absolute ratio
$|\text{cession}|/\text{IND assigned}$. The $2018$ report is published online by SERNAPESCA on the same page as
the $2019$--$2024$ reports, in a per-titular CSV format, and is parsed analogously to the workbook series. The table reports the
$2018$--$2024$ consolidated \emph{RESUMEN} series, the period for which SERNAPESCA
publishes the consolidated summary sheet. The $2013$--$2017$ industrial
quota-control workbooks predate that consolidated sheet and use a per-titular
per-period layout (and, in $2013$, a mid-year LMC-to-LTP regime change), so they
are not tabulated row-by-row here; the industrial cession shares reconstructed
from them ($12$--$72\%$, see text) are archived in
\texttt{cesiones\_ind\_2013\_2017\_rebuilt.csv}.
