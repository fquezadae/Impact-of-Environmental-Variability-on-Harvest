...
classification used in the main text (the Total annual trips section of the main text) follows the
IFOP operational typology for the scientific observers' logbook [@IFOP2016-observadores, Table~13]: LM denotes
