...
state-space specification of Section \ref{sec:stock-dynamics}, together
...
reported in Section \ref{identification} admits two observationally
...
sardina blocks at the main specification of Section
\ref{sec:stock-dynamics}. Anchoveta and sardina shifter ratios remain
...
The comparative statics of Section \ref{projections} integrate two
...
(\(16{,}000\) draws) crossed with the six-model ensemble of Section
\ref{projections}. Jack mackerel is omitted because its non-identified
