...
on the climate shifters \((\rho_s^{SST}, \rho_s^{CHL})\) that enter the
...
biological parameters \((r_s^{0}, K_s, B_{0,s})\) held at the centres of the
...
magnitude of climate forcing---is at most \(3\%\) of total variance in
...
of the main results section---for example, \(-21.4\%\) for the artisanal
fleet under SSP5-8.5 end-of-century in this appendix versus \(-17.6\%\) in
