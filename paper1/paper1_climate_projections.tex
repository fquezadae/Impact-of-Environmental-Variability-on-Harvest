...
shifters carry opposite signs, reflecting a trophic asymmetry; and (iii)
...
relies on the log-linear extrapolation embedded in the shifter function. Both signs are consistent with the regional literature: the negative SST sensitivity for anchoveta aligns with the cold-water anchovy regime documented for the Humboldt Current ecosystem (\citeproc{ref-Alheit2004}{Alheit and Niquen 2004}; \citeproc{ref-Schwartzlose1999-uy}{Schwartzlose et al. 1999}), and the stronger sardine sensitivity matches the negative coupling between SST anomalies and \emph{Strangomera bentincki} recruitment in Centro-Sur Chile reported by (\citeproc{ref-Gomez2012}{Gomez et al. 2012}, \(r=-0.83\)).
...
Third, and in marked contrast, neither SST nor CHL shifters are identified for jack mackerel. The posterior standard deviations \(\sigma_{\text{post}}\)
