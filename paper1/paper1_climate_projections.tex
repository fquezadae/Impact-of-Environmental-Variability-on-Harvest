...
\urlstyle{same}
\hypersetup{
  pdftitle={Climate Shifters in a Structural Bioeconomic Model: Distributional Effects on Chilean Small Pelagic Fisheries},
...
\title{Climate Shifters in a Structural Bioeconomic Model: Distributional Effects on Chilean Small Pelagic Fisheries}
\usepackage{etoolbox}
\makeatletter
...
\midrule
Artisanal & SSP2-4.5, 2041-2060 & 0.95\,[0.93,\,0.96] & -8.6\%\,[-8.7\%,\,-8.0\%] & -2.1\%\,[-2.5\%,\,-1.9\%]\\
Artisanal & SSP2-4.5, 2081-2100 & 0.98\,[0.97,\,0.99] & -9.3\%\,[-9.4\%,\,-9.2\%] & -1.8\%\,[-1.8\%,\,-1.4\%]\\
Artisanal & SSP5-8.5, 2041-2060 & 0.98\,[0.96,\,0.98] & -9.2\%\,[-9.3\%,\,-8.8\%] & -1.8\%\,[-1.8\%,\,-1.7\%]\\
Artisanal & SSP5-8.5, 2081-2100 & 0.99\,[0.99,\,0.99] & -9.5\%\,[-9.5\%,\,-9.4\%] & -0.9\%\,[-1.2\%,\,-0.7\%]\\
Industrial & SSP2-4.5, 2041-2060 & 0.12\,[0.11,\,0.12] & -0.9\%\,[-0.9\%,\,-0.8\%] & -0.8\%\,[-0.8\%,\,-0.7\%]\\
Industrial & SSP2-4.5, 2081-2100 & 0.12\,[0.12,\,0.12] & -0.9\%\,[-0.9\%,\,-0.9\%] & -0.8\%\,[-0.8\%,\,-0.8\%]\\
Industrial & SSP5-8.5, 2041-2060 & 0.12\,[0.12,\,0.12] & -0.9\%\,[-0.9\%,\,-0.9\%] & -0.8\%\,[-0.8\%,\,-0.8\%]\\
Industrial & SSP5-8.5, 2081-2100 & 0.12\,[0.12,\,0.12] & -0.9\%\,[-0.9\%,\,-0.9\%] & -0.8\%\,[-0.8\%,\,-0.8\%]\\
\bottomrule
\end{tabular}
\begin{tablenotes}
\item \textit{Note:} 
...
The small projected change in near-surface wind speed across the CMIP6 ensemble (cross-model median below \(+0.5\) m/s even under SSP5-8.5 end-of-century) implies that the direct weather channel contributes little to the long-run trip response in this fishery. Conditional on the ensemble's wind projections, climate adaptation policy in the Centro-Sur should focus on the institutional architecture that mediates the indirect biomass channel---quota allocation rules, transferability across fleets, and the design of TACs under shifting species productivity---rather than on operational margins such as port infrastructure, vessel reinforcement, or weather-indexed insurance. This conclusion is conditional on the wind projections used here; if downscaled regional climate models predict larger increases in extreme wind events than the CMIP6 monthly means, the relative weight of the direct channel could rise, particularly for the artisanal fleet.
...
\midrule
Artisanal & SSP2-4.5, 2041-2060 & 5 & $-15.2\%$ & 0.1811 & $96\%$ & $4\%$\\
Artisanal & SSP2-4.5, 2081-2100 & 5 & $-17.4\%$ & 0.1941 & $100\%$ & $0\%$\\
Artisanal & SSP5-8.5, 2041-2060 & 6 & $-17.0\%$ & 0.1912 & $100\%$ & $0\%$\\
Artisanal & SSP5-8.5, 2081-2100 & 6 & $-17.8\%$ & 0.1978 & $100\%$ & $0\%$\\
Industrial & SSP2-4.5, 2041-2060 & 5 & $-2.7\%$ & 0.0456 & $98\%$ & $2\%$\\
\addlinespace
Industrial & SSP2-4.5, 2081-2100 & 5 & $-3.1\%$ & 0.0494 & $100\%$ & $0\%$\\
Industrial & SSP5-8.5, 2041-2060 & 6 & $-3.1\%$ & 0.0485 & $100\%$ & $0\%$\\
Industrial & SSP5-8.5, 2081-2100 & 6 & $-3.2\%$ & 0.0497 & $100\%$ & $0\%$\\
\bottomrule
\end{tabular}
\end{table}
...
magnitude (0.1978 for the artisanal fleet and
0.0497 for the industrial fleet under SSP5-8.5
...
0.1978 and the corresponding industrial cell is
0.0497, both of which are small absolute magnitudes and
