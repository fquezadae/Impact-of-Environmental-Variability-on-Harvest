...
Beyond the within-sector quota architecture described above, the partition of each Total Allowable Catch between the artisanal and industrial sectors is fixed by statute at the legislative level. Article\textasciitilde47 of the General Law of Fisheries and Aquaculture (Ley General de Pesca y Acuicultura, LGPA) governed this de jure partition during the estimation window of the present paper (2018--2024); a 2025 reform, Ley\textsubscript{N\(^{\circ}\)}21.752, fixes a new partition in force until 2040. Table\textasciitilde{}\ref{tab:fractioning} summarises the two regimes for the three Central-South small pelagic stocks of interest. Under the pre-2025 regime, the artisanal sector held \(78\%\) of the Central-South anchoveta and sardina com\textquotesingle un TACs and \(10\%\) of the Central-South jurel TAC across the V--Los\textasciitilde Lagos macrozone; Ley\textasciitilde21.752 raises the artisanal share to \(90\%\) in both small pelagic stocks and partitions jurel into a \(30\%\) artisanal share in V--Los\textasciitilde R\textquotesingle ios and a \(15\%\) share in Los\textasciitilde Lagos, for a quota-weighted aggregate of approximately \(28\%\) across the V--Los\textasciitilde Lagos macrozone. The de jure partition admits a single inter-sectoral re-allocation channel, governed by Article\textsubscript{55}T of the LGPA: industrial titulares and artisanal armadores may cede assigned tonnage across the sectoral boundary subject to ex-ante SUBPESCA authorisation, with the transferred volume drawn from the cedent's residual quota and added to the cessionary's effective quota for the calendar year. The SERNAPESCA quota control reports for 2013--2024 document that this channel is heavily used in the Central-South small pelagic fishery (Appendix\textasciitilde{}\ref{appendix-portfolio}, Section\textasciitilde{}\ref{sec:cesiones-evidence}): the industrial sector cedes a stable \(85\)--\(99\%\) of its assigned anchoveta and sardina com\textquotesingle un TACs to artisanal cessionaries every year, in volumes ranging from \(25\) to \(77\)\textasciitilde kt per species-year, while jurel cessions are an order of magnitude smaller and shift direction across years. Two consequences for the present paper follow directly. First, the empirical specifications in Sections\textasciitilde{}\ref{sec:stock-dynamics} and\textasciitilde{}\ref{sec:tripresults} are identified on realised landings by sector, which are post-cession; the asymmetric climate sensitivity we report therefore reflects the operational allocation produced by the joint Article\textsubscript{47--Article}55\textasciitilde T regime, not the de jure Article\textasciitilde47 fractioning alone. Second, Article\textasciitilde6 of Ley\textasciitilde21.752 imposes a specific patent of \(1.3\) monthly tax units per transferred ton on industrial-to-artisanal cessions, with artisanal armadores exempt from the patent in either direction; this is a transactional cost on the pre-existing Article\textsubscript{55}T channel rather than the introduction of a new wedge. Within sectors, transferability also differs sharply: industrial coefficients trade under the LTP regime introduced in 2013, while artisanal RAE assignments remain locked to the regional registry. We return to the welfare implications of the 2025 redistribution under climate stress in Section\textasciitilde{}\ref{sec:discussion} and Appendix\textasciitilde{}\ref{appendix-portfolio}.

\begin{table}[H]
\centering
\caption{Statutory sectoral partition of the Central-South small pelagic TACs, pre- and post-Ley~21.752 (2025).\label{tab:fractioning}}
\begin{threeparttable}
\begin{tabular}{lccc}
\toprule
 & & \multicolumn{2}{c}{Artisanal share of TAC (\%)} \\
\cmidrule(lr){3-4}
Stock & TAC 2024 (kt) & Art.~47 LGPA & Ley~21.752 \\
\midrule
Anchoveta (V--Los~Lagos)             & $211.3$ & $78$ & $90$ \\
Sardina com\'un (V--Los~Lagos)       & $290.6$ & $78$ & $90$ \\
Jurel (V--Los~R\'ios)                & $578.6$ & $10$ & $30$ \\
Jurel (Los~R\'ios--Los~Lagos)        & $80.6$  & $10$ & $15$ \\
\bottomrule
\end{tabular}
\begin{tablenotes}[para,flushleft]
\footnotesize
\item \emph{Notes.} TAC~2024 is the Cuota Global de Captura fixed by SUBPESCA for the calendar year, in thousand tonnes. The pre-2025 fractioning regime follows the Article~47 schedule of the LGPA (DS~430/1991 of the Ministerio de Econom\'ia, Fomento y Reconstrucci\'on, consolidated text of Law~18.892/1989) [@SERNAPESCA2024-cuota]. The 2025 regime corresponds to Article~1 of Ley~N$^{\circ}$~21.752 [@Ley21752-2025; @Boletin17096-21], in force until 31~December~2040. Items~$6$ and~$7$ of Article~$1$ assign $90\%$ of the anchoveta and sardina com\'un TACs to the artisanal sector throughout the V--Los~Lagos macrozone (single block). Items~$4$ and~$5$ partition jurel into two sub-macrozones: $30\%$ artisanal in V--Los~R\'ios and $15\%$ artisanal in Los~Lagos. The SERNAPESCA quota report aggregates Los~R\'ios and Los~Lagos into a single jurel quota of $80.6$~kt; the row in the table applies the Los~Lagos share ($15\%$) as a conservative approximation, with the understanding that the true sub-block share lies between $15\%$ and $30\%$ depending on the Los~R\'ios proportion of the aggregate quota. A use-it-or-lose-it adjustment rule applies in the northern macrozone and is omitted from the table because the present paper focuses on the Central-South. Industrial-to-artisanal inter-sectoral transfers are subject under Article~6 to a specific patent of $1.3$ monthly tax units per transferred ton, with a minimum of $250$ monthly tax units; artisanal armadores are exempt from the patent on transfers in either direction.
\end{tablenotes}
\end{threeparttable}
\end{table}
...
The finding that climate change creates winners and losers within the same fishery has direct implications for quota-allocation policy. A natural first reading would attribute the asymmetry to rigid single-species permits in the artisanal sector, but the underlying institutional architecture is more specific. Both sectors operate \emph{de jure} multi-species permit portfolios: SUBPESCA's \(2012\) registry, the last pre-LTP snapshot of industrial authorisations, records simultaneous authorisations across all three pelagic species for \(76\%\) of industrial vessels (\citeproc{ref-SUBPESCA2012-LTP}{Subsecretaría de Pesca y Acuicultura (SUBPESCA), 2026}); the IFOP logbook in turn reveals that \(90\%\) of artisanal vessels operate a multi-species portfolio in any given year. The asymmetric climate sensitivity we identify is therefore not driven by the \emph{count} of permits held but by four dimensions of the institutional architecture in which those permits are embedded. First, the partition of each Total Allowable Catch between the artisanal and industrial sectors is fixed by statute. During the estimation window (2018--2024), Article\textasciitilde47 of the LGPA allocated \(78\%\) of the Central-South small-pelagic TACs to the artisanal sector and \(90\%\) of the jurel TAC to the industrial sector (Table\textasciitilde{}\ref{tab:fractioning}); Ley\textsubscript{N\(^{\circ}\)}21.752 (\citeproc{ref-Ley21752-2025}{Congreso Nacional de Chile, 2025}) subsequently raised the artisanal share to \(90\%\) in anchoveta and sardina com\textquotesingle un and to \(30\%\) in jurel, in force until 2040. Second, the de jure partition admits a single administratively rationed re-allocation channel under Article\textsubscript{55}T of the LGPA. SERNAPESCA quota control reports for 2013--2024 document that this channel is heavily used in the Central-South small pelagic fishery (Appendix\textasciitilde{}\ref{appendix-portfolio}, Section\textasciitilde{}\ref{sec:cesiones-evidence}): industrial titulares cede \(85\)--\(99\%\) of their assigned anchoveta and sardina com\textquotesingle un TACs to artisanal cessionaries every year, in volumes of \(25\)--\(77\)\textasciitilde kt per species-year, while jurel cessions are an order of magnitude smaller and reverse direction across years. The channel is non-market in the conventional sense---each cession is individually authorised by SUBPESCA and the cession price is not publicly disclosed---but it is operational rather than dormant, and the realised landings on which our specifications identify already reflect the joint Article\textsubscript{47--Article}55\textasciitilde T allocation. Article\textasciitilde6 of Ley\textasciitilde21.752 imposes a transactional cost on this pre-existing channel by levying a specific patent of \(1.3\) monthly tax units per transferred ton on industrial-to-artisanal cessions, with artisanal armadores exempt from the patent in either direction; the patent therefore re-prices the inter-sectoral cession channel rather than introducing a new wedge. Third, within-sector transferability is asymmetric across sectors: industrial coefficients have traded under the LTP regime since \(2013\), while artisanal RAE assignments remain locked to the regional registry, with reassignment occurring only through organisational rather than market channels. Fourth, the revealed portfolio composition of the two sectors differs in its climate correlation structure: the artisanal logbook shows \(80\)--\(86\%\) of activity concentrated in the anchoveta--sardina pair, both of which respond negatively to warming with identified semi-elasticities; the industrial logbook places \(67\%\) of activity in the same pair, with the remainder in jurel and caballa---species whose local climate elasticity is either non-identified at the Centro-Sur scale or estimated on broader-scale stocks. The asymmetry the paper estimates therefore quantifies, in welfare-relevant terms, the cost of a statutory partition mediated by an administratively rationed cession channel and combined with a climate-correlated artisanal portfolio under projected SSP\(5\)-\(8.5\) stress. Appendix\textasciitilde{}\ref{appendix-portfolio} reports the descriptive evidence underlying the multi-permit and portfolio-composition claims, and Appendix\textasciitilde{}\ref{appendix-counterfactual} computes a policy counterfactual under the Ley\textasciitilde21.752 redistribution. The literature on portfolio diversification (\citeproc{ref-Cline2017-dp}{Cline et al., 2017}; \citeproc{ref-Kasperski2013-jz}{Kasperski \& Holland, 2013}) and institutional access constraints (\citeproc{ref-Holland2016-rj}{Holland \& Kasperski, 2016}; \citeproc{ref-Oken2021-of}{Oken et al., 2021}) supports the same reading.

\subsection{Implications of the 2025 fractioning reform}\label{sec:ley21752-implications}

The asymmetry estimated in this paper is identified on the Article\textsubscript{\(47\)}LGPA fractioning regime that prevailed during the estimation window (2018--2024). Ley\textsubscript{N\(^{\circ}\)}21.752, in force from \(2026\) until \(2040\), modifies that regime in two relevant directions for the Central-South small pelagic fishery (\citeproc{ref-Ley21752-2025}{Congreso Nacional de Chile, 2025}). First, the artisanal share of the anchoveta and sardina com\textquotesingle un TACs rises from \(78\%\) to \(90\%\) across the V--Los\textasciitilde Lagos macrozone; the same artisanal sector therefore now holds a deeper claim on stocks whose long-run productivity is projected to collapse under SSP\(5\)-\(8.5\) end-of-century. Second, the artisanal share of the jurel TAC rises from \(10\%\) to \(30\%\) in V--Los\textasciitilde R\textquotesingle ios and from \(10\%\) to \(15\%\) in Los\textasciitilde Lagos---a quota-weighted aggregate of approximately \(28\%\) across the macrozone---giving the artisanal sector partial access to the species whose local productivity is non-identified at the Centro-Sur scale and whose climate response is held fixed in our projections. Table\textasciitilde{}\ref{tab:counterfactual-main} reports the static plug-in counterfactual at SSP\(5\)-\(8.5\) end-of-century, holding the structural posterior and the TAC level at \(2024\) values and varying only the statutory artisanal share.

\begin{table}[H]
\centering
\caption{Static counterfactual: artisanal absolute landing under the Article~$47$~LGPA and Ley~$21.752$ fractioning regimes at SSP$5$-$8.5$ end-of-century, Centro-Sur (V--Los~Lagos), $2024$ Cuotas Globales.\label{tab:counterfactual-main}}
\begin{threeparttable}
\begin{tabular}{lrrrrr}
\toprule
 & & \multicolumn{2}{c}{Artisanal share ($\alpha_s$)} & \multicolumn{2}{c}{Artisanal landing $L_{\text{art}}$ (kt)} \\
\cmidrule(lr){3-4} \cmidrule(lr){5-6}
Stock & TAC 2024 (kt) & Art.~47 & Ley~21.752 & Art.~47 & Ley~21.752 \\
\midrule
Anchoveta (V--Los~Lagos)            & $211.3$ & $0.78$ & $0.90$ & $17.1$  & $19.8$  \\
Sardina com\'un (V--Los~Lagos)      & $290.6$ & $0.78$ & $0.90$ & $0.2$   & $0.3$   \\
Jurel (V--Los~R\'ios)               & $578.6$ & $0.10$ & $0.30$ & $57.9$  & $173.6$ \\
Jurel (Los~R\'ios--Los~Lagos)       & $80.6$  & $0.10$ & $0.15$ & $8.1$   & $12.1$  \\
\addlinespace
...
\begin{tablenotes}[para,flushleft]
\footnotesize
\item \emph{Notes.} Static plug-in evaluation of $L_{\text{art}}^{(R)} = \sum_s \alpha_s^{(R)} \cdot (1 + \widehat{\Delta r_s^{\star}/r_s^{0}}) \cdot Q_s^{0}$, with $\widehat{\Delta r_s^{\star}/r_s^{0}}$ set to the cross-model median at SSP$5$-$8.5$ end-of-century from Table~\ref{tab:growth_compstat} ($-89.6\%$ anchoveta, $-99.9\%$ sardina com\'un, $0\%$ jurel by the non-identification convention of Section~\ref{sec:stock-dynamics}). $Q_s^{0}$ is the $2024$ Cuota Global de Captura. Artisanal fractions follow Article~$47$~LGPA (pre-2025) and Article~$1$ of Ley~$21.752$. The Los~R\'ios--Los~Lagos jurel quota is reported as a single block by SERNAPESCA; the row applies the Los~Lagos artisanal share ($15\%$) as a conservative lower bound on the true sub-block share, which would rise toward $30\%$ to the extent that Los~R\'ios contributes to the aggregate quota. The posterior-propagated version of this table, with cross-model IQR and within-posterior $90\%$ CI, is reported in Appendix~\ref{appendix-counterfactual}.
\end{tablenotes}
\end{threeparttable}
\end{table}

Three readings of Table\textasciitilde{}\ref{tab:counterfactual-main} structure the policy interpretation. First, the redistribution \emph{raises} the absolute artisanal landing under projected SSP\(5\)-\(8.5\) end-of-century stress by approximately \(122\)\textasciitilde kt at the Centro-Sur aggregate, almost entirely through the \(20\)\textasciitilde percentage-point increase in the artisanal jurel share in V--Los\textasciitilde R\textquotesingle ios rather than through the small pelagics. Because the projected productivity of the anchoveta--sardina pair collapses under the same scenario, the \(12\)\textasciitilde percentage-point increase in the artisanal share of those stocks operates on a vanishing base and is therefore mechanically small in absolute terms. Second, the policy logic of the redistribution---which was designed to protect the artisanal sector from over-allocation to the industrial fleet---in fact \emph{deepens} the artisanal exposure to small-pelagic biomass collapse under climate stress: the same artisanal sector now holds \(90\%\) rather than \(78\%\) of a TAC that the structural posterior projects to fall to floor levels. The net welfare effect at SSP\(5\)-\(8.5\) end-of-century therefore depends on whether the jurel access expansion outweighs the deepened small-pelagic exposure, a question that the present static counterfactual cannot answer without an inverse-demand system and a forward-looking allocation rule. Third, the static counterfactual reported in Table\textasciitilde{}\ref{tab:counterfactual-main} should be read as a de jure upper bound on the operational re-allocation produced by Ley\textasciitilde{}\(21.752\), not as the realised effect on sectoral landings. Under the pre-2025 regime, the industrial sector ceded \(85\)--\(99\%\) of its assigned anchoveta and sardina com\textquotesingle un TACs to artisanal cessionaries via Article\textsubscript{\(55\)}T (Appendix\textasciitilde{}\ref{appendix-portfolio}, Section\textasciitilde{}\ref{sec:cesiones-evidence}), so the artisanal sector's effective access to the small-pelagic biomass already approached the de jure ceiling of unity. The \(12\)\textasciitilde percentage-point rise in the artisanal de jure share therefore translates into a much smaller change in realised artisanal landings; the operationally meaningful change in those two stocks is the contraction of the cession volume that industrial titulares had been intermediating for fee, together with the \(1.3\)\textasciitilde UTM/ton patent that Article\textasciitilde{}\(6\) now levies on the residual cession flow. The reform is therefore primarily \emph{redistributive}---it transfers the rent extracted on the Article\textsubscript{\(55\)}T channel from industrial titulares to artisanal armadores---rather than \emph{allocative} in the small pelagics. For jurel the calculus differs: historical cessions are an order of magnitude smaller relative to the TAC, and the \(20\) and \(5\)\textasciitilde percentage-point increases in artisanal de jure shares under items\textasciitilde{}\(4\) and\textasciitilde{}\(5\) of Article\textasciitilde{}\(1\) correspond to an operationally meaningful expansion of artisanal access. A full welfare evaluation of the Ley\textasciitilde{}\(21.752\) regime under climate stress---one that endogenises the realised cession volume as a function of the patent rate and projected stock productivity---is left as the natural extension developed in the Conclusions; the present static plug-in counterfactual quantifies the de jure boundary case from which that endogenous response should be measured.
...
the institutional mechanism developed in Sections\textasciitilde{}\ref{sec:discussion}.
...
Section\textasciitilde{}\ref{sec:discussion}. First, the count of permits per vessel
...
Table\textasciitilde{}\ref{tab:tripcompstatemb} is \emph{not} explained by greater
...
Section\textasciitilde{}\ref{sec:stock-dynamics}, while jurel productivity is
...
Table\textasciitilde{}\ref{tab:fractioning} reports the two regimes side by side.
A static plug-in evaluation of the climate-conditional artisanal
landing under each regime is reported in
Section\textasciitilde{}\ref{sec:ley21752-implications} of the main text
(Table\textasciitilde{}\ref{tab:counterfactual-main}); this appendix records the
...
Table\textasciitilde{}\ref{tab:fractioning}: anchoveta V--Los\textasciitilde Lagos, sardina com\textquotesingle un
V--Los\textasciitilde Lagos, jurel V--Los\textasciitilde R\textquotesingle ios, and jurel Los\textsubscript{R\textquotesingle ios--Los}Lagos.
...
Table\textasciitilde{}\ref{tab:growth_compstat}; the posterior-propagated version
...
Table\textasciitilde{}\ref{tab:trip_compstat}.
...
\item \emph{Notes.} Cross-model median and IQR are taken across the six CMIP6 models of the per-model posterior median; the within-posterior 90\% CI is the median across models of the per-model posterior $[q_{05}, q_{95}]$. The construction parallels Table~\ref{tab:trip_compstat}; see \texttt{R/run\_counterfactual\_ley21752.R} for the pipeline. Jurel is held at $\Delta r^{\star}/r^{0} = 0$ by the non-identification convention of Section~\ref{sec:stock-dynamics}; anchoveta and sardina com\'un use the by-model summaries written by the main T5 pipeline (\texttt{tables/growth\_comparative\_statics\_by\_model.csv}).
\end{tablenotes}
\end{threeparttable}
\end{table}
...
Section\textasciitilde{}\ref{sec:discussion} carries over unchanged.
...
Ley\textasciitilde{}\(21.752\) in Section\textasciitilde{}\ref{sec:ley21752-implications} of the main
