...
The Chilean SPF is managed through an annual Total Allowable Catch (TAC; \emph{Cuota Global}), further subdivided across regions and seasons, with unused quotas reassignable within the fishing year and small fractions reserved for research and contingency. Anchovy and sardine operate under a mixed-species quota framework in which each species has an independent quota but substitution between them is permitted. Because the two species are jointly harvested using the same gear and fishing grounds and are biologically indistinguishable at the point of capture (\citeproc{ref-dresdner2013}{Dresdner et al. 2013}), the species mix of landings depends on the quota allocation rather than on biology or fishing technology.
...
\midrule
$\rho^{SST}$ & Anchovy CS & $\mathcal{N}(-2.3, 1.0)$ & -1.06 & {}[-1.79, -0.38] & 0.43 & 1.000\\
...
$\rho^{CHL}$ & Anchovy CS & $\mathcal{N}(-2.3, 1.0)$ & -3.64 & {}[-5.01, -2.25] & 0.83 & 1.000\\
...
\begin{tablenotes}
\item \textit{Note:} 
\item Shifters are semi-elasticities of intrinsic growth $r_s$ with respect to local SST (°C), local log-CHL (log-points), and the basin-scale Niño 3.4 index. The ENSO row reports the lag-1 refit of Online Appendix E.4 for jack mackerel only; anchovy and sardine inherit their main-specification posteriors. All $\hat{R} \leq 1.01$.
\end{tablenotes}
\end{threeparttable}
\end{table}
...
with sardine's SST semi-elasticity roughly twice that of anchovy; (ii) their CHL
...
First, for the two coastal upwelling stocks---anchovy and sardine
...
materially. For anchovy, a one-degree positive SST anomaly is associated
...
implied declines are 65\% for anchovy and 94\% for sardine. Applied
to a fishery whose anchovy--sardine combined
...
anchovy growth by approximately 29\% while raising sardine growth by
approximately 23\%. The opposite-signed CHL semi-elasticities in Table \ref{tab:rho-posteriors} are consistent with the well-documented anchovy--sardine asymmetry under regime shifts in the Humboldt Current ecosystem (\citeproc{ref-Alheit2004}{Alheit and Niquen 2004}; \citeproc{ref-Schwartzlose1999-uy}{Schwartzlose et al. 1999}): they might reflect the relative competitive dynamics between the two species under high-productivity regimes rather than a direct biological effect of chlorophyll on anchovy. The positive coupling between coastal chlorophyll and common sardine recruitment in Centro-Sur Chile is documented with correlation \(r=0.92\) between CHL and log recruitment by Gomez et al. (\citeproc{ref-Gomez2012}{2012}). A warming-and-greening regime
therefore does not produce a uniform shock on the artisanal fleet,
because anchovy and sardine respond to chlorophyll with opposite signs.
...
\hline \\[-1.8ex] 
 Hold capacity (log m$^3$) & 0.097 (0.221) & 0.132$^{***}$ (0.045) \\ 
  Allocated harvest anchovy ($H^{alloc}_{vy,anch}$, tons) & $-$0.0003 (0.0002) & 0.007$^{***}$ (0.002) \\ 
  ...
  Price anchovy (1000s \$/ton) & $-$0.004 (0.004) & 0.010$^{***}$ (0.003) \\ 
...
\midrule
5 & Sardine CS & SSP2-4.5, 2041-2060 & 5 & +0.58 & +0.022 & -78.6\% & {}[-93.2\%, -72.5\%] & {}[-85.7\%, -67.3\%] & 1.00\\
6 & Sardine CS & SSP2-4.5, 2081-2100 & 5 & +1.31 & +0.000 & -97.2\% & {}[-98.9\%, -89.8\%] & {}[-98.9\%, -92.6\%] & 1.00\\
7 & Sardine CS & SSP5-8.5, 2041-2060 & 6 & +0.92 & +0.007 & -91.1\% & {}[-96.7\%, -78.5\%] & {}[-95.1\%, -83.2\%] & 1.00\\
8 & Sardine CS & SSP5-8.5, 2081-2100 & 6 & +2.39 & -0.013 & -99.9\% & {}[-100.0\%, -99.4\%] & {}[-100.0\%, -99.3\%] & 1.00\\
9 & Jack mackerel CS & SSP2-4.5, 2041-2060 & 5 & +0.58 & +0.022 & n.i. & n.i. & n.i. & n.i.\\
\addlinespace
10 & Jack mackerel CS & SSP2-4.5, 2081-2100 & 5 & +1.31 & +0.000 & n.i. & n.i. & n.i. & n.i.\\
11 & Jack mackerel CS & SSP5-8.5, 2041-2060 & 6 & +0.92 & +0.007 & n.i. & n.i. & n.i. & n.i.\\
12 & Jack mackerel CS & SSP5-8.5, 2081-2100 & 6 & +2.39 & -0.013 & n.i. & n.i. & n.i. & n.i.\\
1 & Anchoveta CS & SSP2-4.5, 2041-2060 & 5 & +0.58 & +0.022 & -50.7\% & {}[-52.7\%, -47.8\%] & {}[-68.0\%, -27.0\%] & 1.00\\
2 & Anchoveta CS & SSP2-4.5, 2081-2100 & 5 & +1.31 & +0.000 & -71.0\% & {}[-76.3\%, -60.4\%] & {}[-91.1\%, -31.0\%] & 1.00\\
\addlinespace
3 & Anchoveta CS & SSP5-8.5, 2041-2060 & 6 & +0.92 & +0.007 & -62.4\% & {}[-68.0\%, -55.9\%] & {}[-80.9\%, -31.2\%] & 1.00\\
4 & Anchoveta CS & SSP5-8.5, 2081-2100 & 6 & +2.39 & -0.013 & -89.6\% & {}[-91.5\%, -87.4\%] & {}[-98.3\%, -54.2\%] & 0.99\\
\bottomrule
\end{tabular}
\begin{tablenotes}
\item \textit{Note:} 
...
\bibitem[\citeproctext]{ref-QuezadaEscalona2025-spf}
Quezada-Escalona, Felipe J., Desiree Tommasi, Isaac C. Kaplan, et al. 2025. {``Socio-Economic Impacts and Responses of the Fishing Industry and Fishery Managers to Changes in Small Pelagic Fish Distribution and Abundance.''} \emph{Reviews in Fish Biology and Fisheries} 35: 1063--93. \url{https://doi.org/10.1007/s11160-025-09949-4}.
