...
\\[-1.8ex] & (1) & (2)\\ 
\hline \\[-1.8ex] 
 Hold capacity (log m$^3$) & 0.005 (0.192) & 0.218$^{***}$ (0.052) \\ 
  Allocated harvest ($H^{alloc}_{vy}$, tons) & 0.00003$^{***}$ (0.00001) & 0.0005$^{***}$ (0.00003) \\ 
  Price jack mackerel (1000s \$/ton) & 0.007$^{***}$ (0.003) & 0.006$^{***}$ (0.002) \\ 
  Price sardine (1000s \$/ton) & $-$0.013$^{***}$ (0.003) & 0.003$^{**}$ (0.002) \\ 
  Price anchoveta (1000s \$/ton) & $-$0.007$^{*}$ (0.004) & 0.013$^{***}$ (0.003) \\ 
  Bad weather days & $-$0.0001 (0.001) & $-$0.001$^{**}$ (0.0005) \\ 
  Veda days & $-$0.081$^{***}$ (0.004) & 0.015$^{***}$ (0.002) \\ 
  Vessel type (UNK) &  & $-$0.475$^{***}$ (0.106) \\ 
  Vessel type (BR) &  & $-$1.022$^{***}$ (0.159) \\ 
  Vessel type (BRV) &  & $-$2.410$^{***}$ (0.296) \\ 
  Vessel type (L) &  & $-$0.070 (0.136) \\ 
  Vessel type (LM) & $-$1.318$^{***}$ (0.167) & 0.171 (0.132) \\ 
  Constant & 16.765$^{***}$ (2.251) & $-$3.879$^{***}$ (0.538) \\ 
 \hline \\[-1.8ex] 
Year fixed effects & Yes & Yes \\ 
Pseudo-$R^2$ (Cragg-Uhler) & 0.282 & 0.615 \\ 
...
\item LR test NB vs Poisson: Industrial $\chi^2$ = 420; Artisanal $\chi^2$ = 39735.9 (both $p < 0.001$).
\end{tablenotes}
\end{threeparttable}
\end{table}
