...
\% DRAFT 2026-05-04 -- pivote ENSO. Drop-in section for paper1/sections/appendix\_spatial\_jurel.Rmd.
...
\% - Ninguno en esta sección (los números vienen del power\_calc\_enso ya corrido).
\% Números directamente del CSV power\_calc\_enso\_table.csv que Felipe ya tiene
\% en data/outputs/t4b/.
...
\% para policy).
\%
\% Placeholders LIVE -- reemplazar después de correr 14b\_fit\_t4b\_full\_enso.R y
\% 01b\_cmip6\_enso\_deltas.R:
\% -0.022 mediana posterior de rho\_enso{[}3{]}
\% -0.81 cuantil 5\% del posterior
\% 0.80 cuantil 95\%
\% 0.490 sd posterior
\% 0.979 sigma\_post / sigma\_prior (= 0.490 / 0.5)
...
\% {[}{[}B\_FACTOR\_JUREL\_END{]}{]} factor multiplicativo sobre r* (escenario A) o ``indeterminado'' (escenario B)
\%
