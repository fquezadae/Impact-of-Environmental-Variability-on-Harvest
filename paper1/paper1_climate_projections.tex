...
\subsection{A.1 Hindcast specification}\label{sec:appendix-stress-spec}
...
\subsection{A.2 Cross-variant fit results}\label{sec:appendix-stress-results}
...
\subsection{A.3 Identifiability diagnostic}\label{sec:appendix-stress-diag}
...
\subsection{A.4 Translation to Bayesian priors}\label{sec:appendix-stress-priors}
...
\subsection{C.1 Smoothed biomass versus observed SSB}\label{c.1-smoothed-biomass-versus-observed-ssb}
...
\subsection{C.2 Year-level residuals}\label{c.2-year-level-residuals}
...
all top-level parameters, and effective sample sizes---are archived in
