...
Beyond the within-sector quota architecture, the partition of each TAC between sectors is fixed by statute. Article\textasciitilde47 of the General Law of Fisheries and Aquaculture (LGPA) governed this de jure partition during the estimation window (2018--2024); a 2025 reform, Ley\textsubscript{N\(^{\circ}\)}21.752, fixes a new partition in force until 2040 (Table\textasciitilde{}\ref{tab:fractioning}). Under Article\textasciitilde47, the artisanal sector held \(78\%\) of the Central-South anchoveta and sardina com\textquotesingle un TACs and \(10\%\) of the jurel TAC; Ley\textasciitilde21.752 raises these to \(90\%\) for both small pelagics and to \(30\%\) in V--Los\textasciitilde R\textquotesingle ios and \(15\%\) in Los\textasciitilde Lagos for jurel. The de jure partition admits a single inter-sectoral re-allocation channel under Article\textsubscript{55}T of the LGPA: industrial titulares and artisanal armadores may cede assigned tonnage across the sectoral boundary subject to ex-ante SUBPESCA authorisation. The channel is heavily used: SERNAPESCA quota control reports for \(2013\)--\(2024\) document that the industrial sector cedes a stable \(85\)--\(99\%\) of its assigned anchoveta and sardina com\textquotesingle un TACs to artisanal cessionaries every year (Online Appendix H.3), while jurel cessions are an order of magnitude smaller and shift direction across years. Our empirical specifications are therefore identified on realised landings, which are post-cession; the operational allocation reflects the joint Article\textsubscript{47--Article}55\textasciitilde T regime, not the de jure fractioning alone. Within sectors, transferability differs sharply: industrial coefficients trade under the LTP regime introduced in 2013, while artisanal RAE assignments remain locked to the regional registry. We return to the welfare implications of the 2025 redistribution under climate stress in Section\textasciitilde{}\ref{sec:discussion} and Online Appendix H.
...
Table \ref{tab:env_projections} summarises the projected environmental changes as cross-model medians with inter-model IQR. SST warms by \(+0.7\) to \(+2.4\,^{\circ}\)C across scenarios. The chlorophyll-a signal is small in magnitude relative to cross-model spread, reflecting documented CMIP6 disagreement on primary-productivity responses. Wind speed increases modestly (\(+0.1\) to \(+0.4\)\textasciitilde m/s cross-model median), but translates into \(+10\) to \(+23.5\) additional bad-weather days per year because the historical daily wind distribution at vessel COGs sits sufficiently close to the 8\textasciitilde m/s operability threshold that a small upward shift in the mean displaces a non-negligible mass of the upper tail past it.
