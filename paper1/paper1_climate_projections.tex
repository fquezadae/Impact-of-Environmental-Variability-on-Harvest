...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[LE,RO]{Asymmetric Climate Impacts on Fishing Effort}
\fancyhead[RE,LO]{\thepage}
\renewcommand{\headrulewidth}{0pt}
\author{Felipe J. Quezada-Escalona}
\affil{Associate Professor, Department of Economics, Universidad de Concepci\'on. Mailing address: Victoria 471, Concepci\'on, Chile. Email: felipequezada@udec.cl. \vspace{-48pt}}
...
\noindent\textbf{Keywords:} climate change; small pelagic fisheries; Bayesian state-space; quota allocation; multi-species; distributional effects.
...
We provide that quantity for the Chilean small pelagic fishery (SPF), the largest fishery in the country at almost 94\% of total Chilean landings in 2019 (\citeproc{ref-SUBPESCA2020}{SUBPESCA, 2020}). The SPF is dominated by three species---anchoveta (\emph{Engraulis ringens}), sardine (\emph{Strangomera bentincki}), and jack mackerel (\emph{Trachurus murphyi})---that share habitat and are coupled through trophic and market linkages (\citeproc{ref-Alheit2004}{Alheit \& Niquen, 2004}; \citeproc{ref-Arancibia2019-FIPA}{Arancibia et al., 2019}), and is managed through an allocation regime (the LMCA, \emph{Límite Máximo de Captura por Armador}) that fixes industrial-versus-artisanal shares with limited cross-sector transferability. The two segments target different portfolios, which is exactly the institutional configuration in which a stock-asymmetric climate shock will translate into a fleet-asymmetric effort response. Cross-country evidence places Chile among the most exposed major fishing nations: Cheung et al. (\citeproc{ref-Cheung2010}{2010}) project a 6--13\% decline in maximum catch potential by mid-century under SRES A1B, and the Southeast Pacific remains one of the least-studied regions for the economic impacts of climate change on fisheries (\citeproc{ref-sumaila2011}{Sumaila et al., 2011}). To our knowledge, no existing study for Chile combines multi-species stock dynamics with vessel-level effort responses under projected climate scenarios.\footnote{For Chile, the only empirical study of fisher behavior using discrete choice modeling that we are aware of is Peña-Torres et al. (\citeproc{ref-Pena-Torres2017-gn}{2017}), which analyses how the El Niño--Southern Oscillation (ENSO) affects location choices in the jack mackerel fishery.}
...
\\[-1.8ex] & (1) & (2)\\ 
\hline \\[-1.8ex] 
 Hold capacity (log m$^3$) & 0.005 (0.192) & 0.221$^{***}$ (0.052) \\ 
  Allocated harvest ($H^{alloc}_{vy}$, tons) & 0.00003$^{***}$ (0.00001) & 0.0005$^{***}$ (0.00003) \\ 
  Price jack mackerel (1000s \$/ton) & $-$0.018$^{**}$ (0.008) & 0.115$^{***}$ (0.008) \\ 
  Price sardine (1000s \$/ton) & $-$0.005 (0.005) & 0.117$^{***}$ (0.007) \\ 
  Price anchoveta (1000s \$/ton) & $-$0.012$^{**}$ (0.006) & 0.159$^{***}$ (0.007) \\ 
  Bad weather days & $-$0.0001 (0.001) & $-$0.001$^{*}$ (0.0005) \\ 
  Veda days & $-$0.081$^{***}$ (0.004) & 0.013$^{***}$ (0.002) \\ 
  Vessel type (UNK) &  & $-$0.461$^{***}$ (0.107) \\ 
  Vessel type (BR) &  & $-$1.006$^{***}$ (0.162) \\ 
  Vessel type (BRV) &  & $-$2.395$^{***}$ (0.289) \\ 
  Vessel type (L) &  & $-$0.067 (0.137) \\ 
  Vessel type (LM) & $-$1.318$^{***}$ (0.167) & 0.169 (0.134) \\ 
  Constant & 21.860$^{***}$ (2.151) & $-$64.144$^{***}$ (3.232) \\ 
 \hline \\[-1.8ex] 
...
\item LR test NB vs Poisson: Industrial $\chi^2$ = 420; Artisanal $\chi^2$ = 40029 (both $p < 0.001$).
\end{tablenotes}
\end{threeparttable}
\end{table}
...
\midrule
Artisanal & SSP2-4.5, 2041-2060 & 0.95\,[0.93,\,0.96] & -8.1\%\,[-8.3\%,\,-7.7\%] & -2.3\%\,[-2.9\%,\,-2.3\%]\\
Artisanal & SSP2-4.5, 2081-2100 & 0.98\,[0.97,\,0.99] & -9.3\%\,[-9.3\%,\,-8.7\%] & -2.1\%\,[-2.3\%,\,-2.0\%]\\
Artisanal & SSP5-8.5, 2041-2060 & 0.98\,[0.96,\,0.98] & -8.7\%\,[-8.9\%,\,-8.3\%] & -2.2\%\,[-2.8\%,\,-1.9\%]\\
Artisanal & SSP5-8.5, 2081-2100 & 0.99\,[0.99,\,0.99] & -10.2\%\,[-10.5\%,\,-10.0\%] & -2.7\%\,[-2.9\%,\,-2.3\%]\\
Industrial & SSP2-4.5, 2041-2060 & 0.12\,[0.11,\,0.12] & -0.7\%\,[-0.7\%,\,-0.7\%] & -0.6\%\,[-0.6\%,\,-0.6\%]\\
Industrial & SSP2-4.5, 2081-2100 & 0.12\,[0.12,\,0.12] & -0.8\%\,[-0.8\%,\,-0.7\%] & -0.7\%\,[-0.7\%,\,-0.6\%]\\
Industrial & SSP5-8.5, 2041-2060 & 0.12\,[0.12,\,0.12] & -0.7\%\,[-0.8\%,\,-0.7\%] & -0.6\%\,[-0.7\%,\,-0.6\%]\\
Industrial & SSP5-8.5, 2081-2100 & 0.12\,[0.12,\,0.12] & -0.9\%\,[-0.9\%,\,-0.8\%] & -0.8\%\,[-0.8\%,\,-0.7\%]\\
\bottomrule
\end{tabular}
\begin{tablenotes}
\item \textit{Note:} 
...
\subsection{Implication for the main claim}\label{implication-for-the-main-claim}

The main-text claim that the climate sensitivity of jack mackerel
cannot be resolved from the available \(2000\)--\(2024\) Centro-Sur
biomass record is robust across three complementary tests of
spatial scale and sample structure. First, the spatial robustness
refit of Sections \ref{sec:appendix-spatial-spec} and
\ref{sec:appendix-spatial-results} varies the environmental
aggregation across \(\mathcal{D}_1\), \(\mathcal{D}_2\), and
\(\mathcal{D}_3\) while holding the biomass record fixed: the
posterior-to-prior ratios remain in \(0.998\)--\(1.014\) across all
three domains. Second, the dual-source extension of Section
\ref{sec:appendix-spatial-dual} adds a second biomass series from
the Northern Chilean acoustic record under a common climate
elasticity, exploiting the \(0.88\) log-scale correlation between
the two Chilean series: the ratios fall only to \(0.94\)--\(0.99\),
remaining well above the threshold for material identification.
Third, an attempt to incorporate the SPRFMO regional assessment
series fails on coherence grounds, indicating that the broader
geographic aggregate is not integrable with the Centro-Sur record
under a single shifter. The convergence of these three tests
indicates a genuinely flat shifter for jack mackerel within the
Centro-Sur biological domain, not an artefact of insufficient
spatial extent, insufficient sample size, or poor source aggregation.

For policy purposes this distinction matters: closing the
identification gap will require either a longer biomass record or
a direct biological measurement of the relevant scale, not a
different choice of spatial aggregation or biomass source within
the existing record. The natural extension is the range-wide
SPRFMO-scale analysis with explicit cross-stock spillover and
spatially-resolved environmental forcing, which we leave to future
work.
...
\midrule
Artisanal & SSP2-4.5, 2041-2060 & 5 & $-14.5\%$ & 0.1647 & $97\%$ & $3\%$\\
Artisanal & SSP2-4.5, 2081-2100 & 5 & $-16.4\%$ & 0.1778 & $100\%$ & $0\%$\\
Artisanal & SSP5-8.5, 2041-2060 & 6 & $-16.1\%$ & 0.1748 & $100\%$ & $0\%$\\
Artisanal & SSP5-8.5, 2081-2100 & 6 & $-17.5\%$ & 0.1804 & $100\%$ & $0\%$\\
Industrial & SSP2-4.5, 2041-2060 & 5 & $-2.2\%$ & 0.0341 & $99\%$ & $1\%$\\
\addlinespace
Industrial & SSP2-4.5, 2081-2100 & 5 & $-2.4\%$ & 0.0371 & $100\%$ & $0\%$\\
Industrial & SSP5-8.5, 2041-2060 & 6 & $-2.4\%$ & 0.0365 & $100\%$ & $0\%$\\
Industrial & SSP5-8.5, 2081-2100 & 6 & $-2.6\%$ & 0.0374 & $100\%$ & $0\%$\\
\bottomrule
\end{tabular}
\end{table}
...
within-model share rises from 99\%
...
magnitude (0.1804 for the artisanal fleet and
0.0374 for the industrial fleet under SSP5-8.5
...
of the main results section---for example, \(-17.8\%\) for the artisanal
fleet under SSP5-8.5 end-of-century in this appendix versus \(-9.5\%\) in
...
0.1804 and the corresponding industrial cell is
0.0374, both of which are small absolute magnitudes and
