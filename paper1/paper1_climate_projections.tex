...
\hline \\[-1.8ex] 
 Hold capacity (log m$^3$) & 0.097 (0.221) & 0.132$^{***}$ (0.046) \\ 
  ...
  $H^{alloc}_{vy,anch} \times$ Vessel type (BR) &  & $-$0.021$^{***}$ (0.008) \\ 
  $H^{alloc}_{vy,anch} \times$ Vessel type (BRV) &  & $-$66.546$^{***}$ (13.119) \\ 
  $H^{alloc}_{vy,anch} \times$ Vessel type (L) &  & 501.903 (501.942) \\ 
  $H^{alloc}_{vy,anch} \times$ Vessel type (LM) &  & $-$0.017$^{***}$ (0.003) \\ 
  $H^{alloc}_{vy,anch} \times$ Vessel type (UNK) &  & $-$0.013$^{***}$ (0.003) \\ 
