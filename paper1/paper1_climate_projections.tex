...
\toprule
SSP & Window & $\Delta$ SST ($^{\circ}$C) & $\Delta\log$ CHL & $\Delta$ wind speed (m/s)\\
\midrule
SSP2-4.5 & 2081--2100 & $+1.44$ \,[$+0.96$, $+1.91$] & $+0.000$ \,[$+0.000$, $+0.000$] & $+0.19$ \,[$+0.10$, $+0.24$]\\
SSP2-4.5 & 2041--2060 & $+0.74$ \,[$+0.52$, $+0.92$] & $+0.000$ \,[$+0.000$, $+0.000$] & $+0.14$ \,[$+0.13$, $+0.15$]\\
SSP5-8.5 & 2081--2100 & $+2.39$ \,[$+1.93$, $+3.29$] & $+0.000$ \,[$+0.000$, $+0.000$] & $+0.42$ \,[$+0.36$, $+0.45$]\\
SSP5-8.5 & 2041--2060 & $+0.92$ \,[$+0.61$, $+1.23$] & $+0.000$ \,[$+0.000$, $+0.000$] & $+0.21$ \,[$+0.14$, $+0.32$]\\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
Anchoveta CS & SSP2-4.5, 2041-2060 & 5 & +0.58 & +0.000 & -45.4\% & {}[-52.7\%, -40.4\%] & {}[-64.5\%, -17.3\%] & 1.00\\
Anchoveta CS & SSP2-4.5, 2081-2100 & 5 & +1.31 & +0.000 & -71.0\% & {}[-74.5\%, -58.3\%] & {}[-90.4\%, -27.5\%] & 1.00\\
Anchoveta CS & SSP5-8.5, 2041-2060 & 6 & +0.92 & +0.000 & -59.3\% & {}[-71.0\%, -46.8\%] & {}[-79.2\%, -25.7\%] & 1.00\\
Anchoveta CS & SSP5-8.5, 2081-2100 & 6 & +2.39 & +0.000 & -90.1\% & {}[-96.0\%, -85.6\%] & {}[-98.3\%, -54.3\%] & 1.00\\
Jack mackerel CS & SSP2-4.5, 2041-2060 & 5 & +0.58 & +0.000 & n.i. & n.i. & n.i. & n.i.\\
\addlinespace
Jack mackerel CS & SSP2-4.5, 2081-2100 & 5 & +1.31 & +0.000 & n.i. & n.i. & n.i. & n.i.\\
Jack mackerel CS & SSP5-8.5, 2041-2060 & 6 & +0.92 & +0.000 & n.i. & n.i. & n.i. & n.i.\\
Jack mackerel CS & SSP5-8.5, 2081-2100 & 6 & +2.39 & +0.000 & n.i. & n.i. & n.i. & n.i.\\
Common sardine CS & SSP2-4.5, 2041-2060 & 5 & +0.58 & +0.000 & -79.8\% & {}[-93.2\%, -74.6\%] & {}[-86.6\%, -69.0\%] & 1.00\\
Common sardine CS & SSP2-4.5, 2081-2100 & 5 & +1.31 & +0.000 & -97.3\% & {}[-98.9\%, -90.1\%] & {}[-98.9\%, -92.9\%] & 1.00\\
\addlinespace
Common sardine CS & SSP5-8.5, 2041-2060 & 6 & +0.92 & +0.000 & -91.6\% & {}[-96.6\%, -80.8\%] & {}[-95.4\%, -84.0\%] & 1.00\\
Common sardine CS & SSP5-8.5, 2081-2100 & 6 & +2.39 & +0.000 & -99.9\% & {}[-100.0\%, -99.4\%] & {}[-100.0\%, -99.2\%] & 1.00\\
\bottomrule
\end{tabular}
\begin{tablenotes}
\item \textit{Note:} 
...
The magnitudes are economically first-order for a Centro-Sur fishery whose combined TAC is in the low hundred-thousand-tonne range. Under the moderate SSP2-4.5 mid-century scenario (cross-model median \(+0.58\,^{\circ}\)C, \(\Delta\log\text{CHL}\approx 0\)), the cross-model median of anchoveta's intrinsic productivity declines by \(45\%\) and sardina común's by \(80\%\), with posterior probability of negative impact equal to one in both cases. Under the high-emissions SSP5-8.5 end-of-century scenario (cross-model median \(+2.39\,^{\circ}\)C, \(\Delta\log\text{CHL}\approx 0\)) the cross-model medians deepen to \(-90\%\) and \(-99.9\%\) respectively, and the entire \(90\%\) credible interval of each stock lies below zero in every model of the ensemble. The identified signs confirm the qualitative reading of the shifters in Section \ref{identification}: both coastal stocks respond negatively to SST, but sardina común carries roughly twice the SST semi-elasticity of anchoveta, and its CHL semi-elasticity is of the opposite sign, so that the compound response---negative thermal shock combined with negative primary-productivity shock---is sharper for sardina than for anchoveta.
...
\midrule
Anchoveta CS & SSP2-4.5, 2041-2060 & 5 & $-44.4\%$ & 0.199 & $56\%$ & $44\%$\\
Anchoveta CS & SSP2-4.5, 2081-2100 & 5 & $-65.4\%$ & 0.220 & $69\%$ & $31\%$\\
Anchoveta CS & SSP5-8.5, 2041-2060 & 6 & $-55.9\%$ & 0.209 & $56\%$ & $44\%$\\
Anchoveta CS & SSP5-8.5, 2081-2100 & 6 & $-85.5\%$ & 0.196 & $88\%$ & $12\%$\\
Common sardine CS & SSP2-4.5, 2041-2060 & 5 & $-78.8\%$ & 0.163 & $9\%$ & $91\%$\\
\addlinespace
Common sardine CS & SSP2-4.5, 2081-2100 & 5 & $-94.1\%$ & 0.066 & $21\%$ & $79\%$\\
Common sardine CS & SSP5-8.5, 2041-2060 & 6 & $-87.4\%$ & 0.114 & $14\%$ & $86\%$\\
Common sardine CS & SSP5-8.5, 2081-2100 & 6 & $-99.5\%$ & 0.009 & $61\%$ & $39\%$\\
\bottomrule
\end{tabular}
\end{table}

The decomposition reveals a sharp contrast between the two identified
stocks. For \emph{common sardine}, the between-model component dominates the
total variance in three of the four scenario--window pairs (between \(79\)
...
than the between-model component, and reaches \(88\%\) of the total
variance under SSP5-8.5 by end-of-century. This reflects a wider
posterior on \(\rho^{SST}_{\text{anch}}\): the historical record from
2000 to 2024 has identified the anchoveta shifter less precisely than
the sardine shifter, consistent with the wider \(90\%\) credible interval
in the structural Section \ref{identification}. The bottleneck on the
anchoveta projection is therefore the structural posterior; tightening
the historical inference would do more for the anchoveta projection
than expanding the ensemble.

The single exception in the table is \emph{common sardine} under SSP5-8.5
end-of-century, where the within share rises to \(61\%\). This row is a
...
\(0.009\), so the distribution is essentially pinned at the lower bound
...
uncertainty is climate-driven --- is the structural reading; the SSP5-8.5
end-of-century cell is reported for completeness but should be read with
the floor effect in mind.
...
$88\%$ of the total variance is attributable to the structural
posterior. Jack mackerel omitted (non-identified shifter).}
