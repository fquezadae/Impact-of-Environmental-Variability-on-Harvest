...
Output prices $p_{sy}$ are species-specific ex-vessel prices constructed from IFOP's \emph{Monitoreo Económico de la Industria Pesquera y Acuícola Nacional} by aggregating the monthly plant-level series to annual averages over peak fishing months, following @dresdner2013, and deflating to constant 2018 pesos using the consumer price index from the Central Bank of Chile.
