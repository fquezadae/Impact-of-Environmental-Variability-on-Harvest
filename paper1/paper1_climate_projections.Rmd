...
Several extensions are natural. A bi-level Stackelberg optimisation using our posterior as prior would deliver full forward biomass trajectories under endogenous TACs and effort allocation [@Kasperski2015-jm]. Connecting the multi-species model to the location-choice literature [@Dupont1993-jn; @Smith2005-us; @Hicks2020-mz] through a daily discrete-choice specification with environmentally informed species distribution models would capture within-port heterogeneity and the spatial dimension of effort reallocation [@Quezada2026-cp]. Extending the trip equation beyond the three pelagic species to other coastal species recorded in the IFOP logbook would quantify the species-substitution adaptation margin available to artisanal fishers. Finally, incorporating risk preferences and production risk would provide a richer characterisation of fleet responses to projected environmental variability [@Kasperski2013-jz].
