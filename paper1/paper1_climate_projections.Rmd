...
For the artisanal fleet, the anchoveta response varies sharply by vessel type: small-vessel categories (BM = \emph{bote motor}, $8\%$ of the panel) exhibit a strong positive elasticity---when their anchoveta allocation rises, they fish more trips---while large-vessel categories (LM = \emph{lancha motor}, $77\%$) show near-zero response. Without a vessel-type interaction, this within-class heterogeneity collapses to a misleading aggregate; we therefore include $H^{alloc}_{vy,\text{anchoveta}} \times \text{vesselType}$ in the artisanal specification, following @Kasperski2015-jm. The interaction is estimated only for vesselType categories with at least $50$ vessel-year observations; the remaining categories (collectively $<0.1\%$ of artisanal effort) carry an aggregated coefficient. Sardine and jack mackerel quotas do not display this within-fleet heterogeneity.
