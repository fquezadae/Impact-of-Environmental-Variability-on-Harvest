...
knitr::kable(env_wide, format = "latex", booktabs = TRUE, escape = FALSE,
  ...
  kableExtra::footnote(general = paste(
      "SSP2-4.5 panels use $n_m=5$ because one of the six CMIP6 models in the",
      "ensemble does not publish chlorophyll-a projections for SSP2-4.5;",
      "this matches the sub-ensemble used in Table \\\\ref{tab:growth_compstat}."),
...
gcs_kable <- kable(gcs_tbl, format = "latex", booktabs = TRUE, escape = FALSE,
      align = "llccccccr",
      caption = "Comparative statics on intrinsic stock productivity under the CMIP6 six-model ensemble. SSP2-4.5 panels use $n_m=5$ because one of the six models does not publish chlorophyll-a projections for that scenario; SSP5-8.5 panels use all six. \\label{tab:growth_compstat}") %>%
  add_header_above(c(" " = 5, "Summaries of $\\\\Delta r_s^{\\\\star}/r_s^{0}$" = 4),
                   escape = FALSE) %>%
