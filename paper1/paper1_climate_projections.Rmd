...
Latent biomass is linked to the official survey-based estimates of total stock biomass $B_{i,t}^{\text{obs}}$ published by IFOP for all three species in Centro-Sur Chile, through a log-normal measurement equation,
