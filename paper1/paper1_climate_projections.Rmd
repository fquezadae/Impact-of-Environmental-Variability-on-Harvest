...
Beyond the within-sector quota architecture described above, the partition of each Total Allowable Catch between the artisanal and industrial sectors is fixed by statute at the legislative level. Article~47 of the General Law of Fisheries and Aquaculture (Ley General de Pesca y Acuicultura, LGPA) governed this de jure partition during the estimation window of the present paper (2018--2024); a 2025 reform, Ley~N$^{\circ}$~21.752, fixes a new partition in force until 2040. Table~\ref{tab:fractioning} summarises the two regimes for the three Central-South small pelagic stocks of interest. Under the pre-2025 regime, the artisanal sector held $78\%$ of the Central-South anchoveta and sardina com\'un TACs and $10\%$ of the Central-South jurel TAC across the V--Los~Lagos macrozone; Ley~21.752 raises the artisanal share to $90\%$ in both small pelagic stocks and partitions jurel into a $30\%$ artisanal share in V--Los~R\'ios and a $15\%$ share in Los~Lagos, for a quota-weighted aggregate of approximately $28\%$ across the V--Los~Lagos macrozone. The de jure partition admits a single inter-sectoral re-allocation channel, governed by Article~55~T of the LGPA: industrial titulares and artisanal armadores may cede assigned tonnage across the sectoral boundary subject to ex-ante SUBPESCA authorisation, with the transferred volume drawn from the cedent's residual quota and added to the cessionary's effective quota for the calendar year. The SERNAPESCA quota control reports for 2013--2024 document that this channel is heavily used in the Central-South small pelagic fishery (Appendix~\ref{appendix-portfolio}, Section~\ref{sec:cesiones-evidence}): the industrial sector cedes a stable $85$--$99\%$ of its assigned anchoveta and sardina com\'un TACs to artisanal cessionaries every year, in volumes ranging from $25$ to $77$~kt per species-year, while jurel cessions are an order of magnitude smaller and shift direction across years. Two consequences for the present paper follow directly. First, the empirical specifications in Sections~\ref{sec:stock-dynamics} and~\ref{sec:tripresults} are identified on realised landings by sector, which are post-cession; the asymmetric climate sensitivity we report therefore reflects the operational allocation produced by the joint Article~47--Article~55~T regime, not the de jure Article~47 fractioning alone. Second, Article~6 of Ley~21.752 imposes a specific patent of $1.3$ monthly tax units per transferred ton on industrial-to-artisanal cessions, with artisanal armadores exempt from the patent in either direction; this is a transactional cost on the pre-existing Article~55~T channel rather than the introduction of a new wedge. Within sectors, transferability also differs sharply: industrial coefficients trade under the LTP regime introduced in 2013, while artisanal RAE assignments remain locked to the regional registry. We return to the welfare implications of the 2025 redistribution under climate stress in Section~\ref{sec:discussion} and Appendix~\ref{appendix-portfolio}.
...
```{r appendix-portfolio-cf, child='paper1/sections/appendix_h_portfolio_and_counterfactual.Rmd'}
```
