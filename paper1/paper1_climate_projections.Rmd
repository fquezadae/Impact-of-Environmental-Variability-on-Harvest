...
Beyond the within-sector quota architecture described above, the partition of each Total Allowable Catch between the artisanal and industrial sectors is fixed by statute and cannot be adjusted through any administrative or market channel below the legislative level. Article~47 of the General Law of Fisheries and Aquaculture (Ley General de Pesca y Acuicultura, LGPA) governed this partition during the estimation window of the present paper (2018--2024); a 2025 reform, Ley~N$^{\circ}$~21.752, fixes a new partition in force until 2040. Table~\ref{tab:fractioning} summarises the two regimes for the three Central-South small pelagic stocks of interest. Under the pre-2025 regime, the artisanal sector held $78\%$ of the Central-South anchoveta and sardina com\'un TACs and $10\%$ of the Central-South jurel TAC across the V--Los~Lagos macrozone; Ley~21.752 raises the artisanal share to $90\%$ in both small pelagic stocks and partitions jurel into a $30\%$ artisanal share in V--Los~R\'ios and a $15\%$ share in Los~Lagos, for a quota-weighted aggregate of approximately $28\%$ across the V--Los~Lagos macrozone. Importantly, both regimes preserve the institutional architecture of the wedge: inter-sectoral transfers remain non-market objects, subject under Article~6 of Ley~21.752 to a specific patent of $1.3$ monthly tax units per transferred ton on industrial transfers, with artisanal armadores exempt from the patent. Within sectors, transferability differs sharply: industrial coefficients trade under the LTP regime introduced in 2013, while artisanal RAE assignments remain locked to the regional registry. The empirical specifications in Sections~\ref{sec:stock-dynamics} and~\ref{sec:tripresults} are identified on the pre-2025 regime; we return to the welfare implications of the 2025 redistribution under climate stress in Section~\ref{sec:discussion} and Appendix~\ref{appendix-portfolio}.
