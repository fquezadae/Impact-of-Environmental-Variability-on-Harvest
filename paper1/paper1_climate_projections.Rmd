...
To address this question, we estimate a multi-species bioeconomic model inspired by @Kasperski2015-jm. This model captures the biological and economic interrelations among species to study how climate variability affects stock productivity and fishing effort. We estimate a three-equation SUR system for stock growth dynamics and a negative binomial model for annual fishing trips, and combine these with CMIP6 climate projections to project changes in fishing activity under different emission scenarios. We decompose the climate impact into a direct weather channel (wind affecting operational feasibility) and an indirect biomass channel (temperature and chlorophyll affecting stock growth and harvest allocations).
