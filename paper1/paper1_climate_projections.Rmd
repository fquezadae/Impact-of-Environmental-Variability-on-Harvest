...
tex_nb <- capture.output(
  stargazer(
    ...
    covariate.labels = c(
      ...
      "Vessel type (L)",
      "Vessel type (LM)",
      "$H^{alloc}_{vy,anch} \\times$ Vessel type (BR)",
      "$H^{alloc}_{vy,anch} \\times$ Vessel type (BRV)",
      "$H^{alloc}_{vy,anch} \\times$ Vessel type (L)",
