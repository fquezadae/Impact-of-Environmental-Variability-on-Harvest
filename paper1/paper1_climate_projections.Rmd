...
These mechanics imply that climate-adaptation policy in the Centro-Sur small pelagic fishery should focus on differential access to biological resources rather than on quota allocation alone. The cross-sector cession regime documented in Online Appendix F already transfers most anchoveta and sardine quota toward the artisanal fleet ($85$--$99%$ each year), but these are precisely the stocks projected to experience the largest climate-driven declines in productivity. In contrast, the offshore jack mackerel stock remains predominantly accessible to industrial vessels because of the operating-range limitations of the artisanal fleet. As a result, climate change amplifies an existing access asymmetry: the fleet segment most dependent on climate-sensitive coastal stocks is also the segment least able to shift effort toward the more resilient offshore resource.

Under this interpretation, adaptation policies that expand the effective operating range and resilience of artisanal vessels may yield greater long-run benefits than reforms focused solely on quota allocation. Investments in vessel upgrading, safety equipment, port infrastructure, weather forecasting services, weather-indexed insurance, or other measures that relax technological constraints could increase the ability of artisanal fishers to access alternative fishing opportunities as coastal productivity declines. Whether such a transition is socially desirable depends on broader economic, cultural, and governance considerations beyond the scope of this study. More generally, our results suggest that technological access, rather than quota ownership alone, is likely to become the binding constraint under future climate change. Put differently, under climate change the relevant constraint may be less who owns the quota than who can physically reach the fish.

One limitation deserves particular emphasis. The apparent climate resilience of jack mackerel reflects non-identification of local climate effects rather than evidence of biological insensitivity. Existing evidence suggests that climate variability affects the species through changes in distribution, migration, and spawning dynamics, but these effects are not identified in our aggregate productivity specification. Consequently, the projected asymmetry between fleets should be interpreted as conditional on the current evidence available for jack mackerel productivity. Resolving this uncertainty will require basin-scale analyses using SPRFMO-wide data.
...
More broadly, our findings suggest that climate impacts on fisheries depend not only on how environmental change affects fish populations, but also on how technology, geography, and institutions determine which fleets can access those populations. Differences in fleet vulnerability arise primarily from portfolio composition and effective access to offshore resources rather than from the formal allocation of harvesting rights.
