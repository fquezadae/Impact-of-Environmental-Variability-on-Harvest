...
kable(tcs_tbl, format = "latex", booktabs = TRUE, escape = FALSE,
  ...
  footnote(general = paste(
    ...
    "The narrow cross-IQR observed in many cells reflects a floor effect: once Schaefer steady-state collapse saturates the portfolio-weighted biomass factor across models, the trip response converges to exp(-beta * H_alloc * 1), independent of climate magnitude. See Appendix F for a complementary variance decomposition of the underlying productivity response."
  ),
  general_title = "Note:", escape = TRUE, threeparttable = TRUE)
