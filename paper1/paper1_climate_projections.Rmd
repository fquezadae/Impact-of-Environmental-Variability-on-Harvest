...
The partition of each TAC between the industrial and artisanal sectors is fixed by statute. The pre-reform partition governed the de jure allocation during the estimation window (2013--2024); a 2025 reform [@Ley21752-2025] fixes a new partition in force until 2040 (Table \ref{tab:fractioning}). Under the pre-reform regime, the artisanal sector held $78\%$ of the Central-South anchoveta and sardine TACs and $10\%$ of the jack mackerel TAC; the 2025 reform raises these to $90\%$ for both small pelagics and to $30\%$ in Valparaíso--Los Ríos and $15\%$ in Los Lagos for jack mackerel. The de jure partition admits a single administratively rationed inter-sectoral re-allocation channel, subject to ex-ante SUBPESCA authorisation. SERNAPESCA quota control reports for $2013$--$2024$ document that the industrial sector cedes a stable $85$--$99\%$ of its assigned anchoveta and sardine TACs to artisanal cessionaries every year (Online Appendix H.3), while jack mackerel cessions are an order of magnitude smaller and shift direction across years. Our empirical specifications are therefore identified on realised landings, which are post-cession: the operational allocation reflects the joint statutory--cession regime, not the de jure fractioning alone.
...
Three readings of Table \ref{tab:counterfactual-main} structure the policy interpretation. First, the redistribution \emph{raises} the absolute artisanal landing under projected SSP$5$-$8.5$ end-of-century stress by approximately $122$ kt at the Centro-Sur aggregate, almost entirely through the $20$-percentage-point increase in the artisanal jack mackerel share in Valparaíso--Los Ríos rather than through the small pelagics, whose projected productivity collapse makes the $12$-percentage-point increase in the artisanal share mechanically small. Second, the policy logic of the redistribution---designed to protect the artisanal sector---in fact \emph{deepens} the artisanal exposure to small-pelagic biomass collapse under climate stress: the same sector now holds $90\%$ rather than $78\%$ of a TAC projected to fall to floor levels. The net welfare effect therefore depends on whether the jack mackerel access expansion outweighs the deepened small-pelagic exposure. Third, the counterfactual is a de jure upper bound on the operational re-allocation. Under the pre-2025 regime the industrial sector ceded $85$--$99\%$ of its assigned anchoveta and sardine TACs to artisanal cessionaries via the cession channel (Online Appendix H.3), so the $12$-percentage-point rise in the artisanal de jure share translates into a much smaller change in realised landings; the operationally meaningful change is the contraction of the cession volume that industrial titulares had been intermediating for fee, together with the $1.3$ UTM/ton patent that the 2025 reform now levies on the residual cession flow. The reform is therefore primarily \emph{redistributive} (transferring rent from industrial titulares to artisanal armadores) rather than \emph{allocative} in the small pelagics; for jack mackerel, historical cessions are an order of magnitude smaller and the de jure expansion is operationally meaningful.
