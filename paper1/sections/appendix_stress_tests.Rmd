...
## A.1 Hindcast specification {#sec:appendix-stress-spec}
...
## A.2 Cross-variant fit results {#sec:appendix-stress-results}
...
kable(mape_tbl, format = "latex", booktabs = TRUE, escape = FALSE,
  ...
  footnote(general = paste(
      ...
      "the centres of the official IFOP/SPRFMO priors. Anchoveta and sardina common have N = 24 yearly",
...
## A.3 Identifiability diagnostic {#sec:appendix-stress-diag}
...
## A.4 Translation to Bayesian priors {#sec:appendix-stress-priors}
