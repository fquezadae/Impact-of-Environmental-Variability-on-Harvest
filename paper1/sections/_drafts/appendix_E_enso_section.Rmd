...
(@Arcos2001-jq; @Pena-Torres2017-gn; @Espinoza2013-jc).
...
revised Tables \ref{tab:climate_compstat_3stocks} and
...
choice. The biological readings of @Arcos2001-jq, @Pena-Torres2017-gn,
and @Espinoza2013-jc remain consistent with the appendix result: each
...
\ref{tab:climate_compstat_3stocks} and \ref{tab:trip_compstat} of the
