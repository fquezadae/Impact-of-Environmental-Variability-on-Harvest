...
kable(rho_tbl, format = "latex", booktabs = TRUE, escape = FALSE,
  ...
  footnote(general = paste(
      ...
      "with respect to SST anomalies (in \u00b0C) and log-CHL anomalies, respectively.",
      "Priors are adopted from the stock-specific stress-test results reported in Appendix A.",
      "The posterior-to-prior standard deviation ratio measures the amount of prior-to-posterior",
