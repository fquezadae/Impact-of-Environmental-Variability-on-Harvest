...
<!-- TODO (wiring): reactivar este bloque cuando exista el child
     appendix_posterior_diagnostics.Rmd (= "Appendix C") que defina los
     labels \label{fig:ppc-smooth-vs-obs} y \label{fig:ppc-residuals}.
     Mientras tanto queda comentado para que el knit no produzca "??"
     en el PDF. El argumento central de la seccion no depende de este
     parrafo -- vive en las subsecciones previas.
