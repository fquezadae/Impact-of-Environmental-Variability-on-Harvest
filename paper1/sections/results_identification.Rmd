...
(CI $[-3.46, -2.02]$). Both signs are consistent with the regional literature: the negative SST sensitivity for anchoveta aligns with the cold-water anchovy regime documented for the Humboldt Current ecosystem [@Alheit2004; @Schwartzlose1999-uy], and the stronger sardine sensitivity matches the negative coupling between SST anomalies and \emph{Strangomera bentincki} recruitment in Centro-Sur Chile reported by @Gomez2012 with $r=-0.83$. Evaluated at one historical standard deviation of
