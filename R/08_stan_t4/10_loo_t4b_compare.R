...
load_fit_and_data <- function(tag) {
  ...
  # NO llamar init_model_methods aqui. Deja que $loo(moment_match=TRUE)
  # gatille la auto-compilacion ("Compiling additional model methods...").
  # Inicializar Xptr tras readRDS con un exe pre-compilado-con-methods
  # dispara "NULL value passed as symbol address" por un bug de
  # serializacion en cmdstanr.
