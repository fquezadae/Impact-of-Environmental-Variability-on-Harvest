...
`\begin{equation}
p_{iy} = \gamma_{h_i} h_{iy} + x'\beta +\epsilon_{iy}, \quad i = 1,\ldots,n, \ j = 1,\ldots,n.
\label{eq6}
\end{equation}
`
...
Maybe then see if we need to estimate a AR(2) model?? (**HELP LEO!!!**):
`\begin{equation}
p_{iy} = \mathbf{\sum_j^n \gamma_j p_{j,y-1}} + \gamma_{h_i} h_{iy} + x'\beta + \epsilon_{iy}, \quad i = 1,\ldots,n, \ j = 1,\ldots,n.
\label{eq7}
\end{equation}
`
