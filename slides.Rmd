...
2. Simulations
  - Use models parameters to:
    - Obtain the optimal **harvest** and **quota** (historical and for different climate scenarios).
    - Evaluate effects on harvest, prices and **profits**, and **species substitution**
