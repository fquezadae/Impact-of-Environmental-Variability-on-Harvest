...
The Chilean fishing sector is managed primarily through a Total Allowable Catch (TAC; *Cuota Global* in Spanish), which is divided between the artisanal and industrial sectors. A small share (≈2%) is reserved for research, with additional portions allocated to contingency and human consumption. The TAC is further subdivided by region and season where the fishery operates, and unused quotas may be reassigned during the fishing year.
...
The TAC allocated to artisanal sector, instead, is ....
