...
## Quota allocation
Anchoveta and sardine are regulated as a mixed-species fishery: they have separate quotas, but if one species is unavailable, the quota for the other can be used as a substitute. Additionally, some quota originally allocated to industrial fleets is transferred to the artisanal sector, with these transactions potentially traceable through SERNAPESCA data.
...
In Chile, part of the industrial quotas for jack mackerel, sardine, and anchovy have been allocated through transferable license auctions since 2015. These sealed-bid, first-price auctions set aside a share of quota, often prioritizing small and medium-sized enterprises, and imposed limits to prevent excessive concentration. While the system helped distribute access to these fisheries, it also faced challenges, including low participation, difficulties for firms to express economies of scale, and indications of possible coordinated bidding behavior.
