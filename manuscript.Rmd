...
catch information on the Chilean fleet's fishing operation per trip [see e.g. @PeñaElNiño and [IFOP data observatory](ifop.dataobservatory.net)].
...
traveled during a trip, where the price of distance traveled is the diesel cost.
