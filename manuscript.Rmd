...
```
 ...
 -   Environmental covariates -- Use R package **copernicusmarine**
        - Historical (2012–2024):
          - Use Copernicus GLORYS12V1 (ocean reanalysis, ~8 km) → SST, salinity, currents.
          - Use ERA5 (atmosphere reanalysis, 25 km) → winds, storms/bad weather days.
          - Use GlobColour (Copernicus ocean colour, 4 km) → chlorophyll.
          
        - Future (2040–2050):
          - Use Copernicus downscaled CMIP6 projections (if available for the variables I need).
          - If not, fall back on CMIP6 coarse data (~100 km) and **downscale statistically**.
