...
```{r strategy-table-logbooks_ART, echo=FALSE, message=FALSE, warning=FALSE, results='asis'}
...
```{r strategy-table-logbooks_IND, echo=FALSE, message=FALSE, warning=FALSE, results='asis'}
