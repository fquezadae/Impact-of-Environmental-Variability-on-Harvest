...
```{r strategy-table-logbooks-ART, echo=FALSE, results='asis', fig.height=6, fig.width=8}
...
```{r strategy-table-logbooks-IND, echo=FALSE, results='asis', fig.height=6, fig.width=8}
