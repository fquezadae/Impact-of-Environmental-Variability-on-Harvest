...
- **SOLICITAR!** 
  - Stock abundance and vessel landings were obtained from stock assessment by request to the Chilean National Fisheries and Aquaculture Service (SERNAPESCA) and the Chilean Undersecretariat for Fisheries and Aquaculture (SUBPESCA).
  ...
  - Data at the trip level ([IFOP data observatory?](ifop.dataobservatory.net)]).
    - Time spent at sea during a trip, 
