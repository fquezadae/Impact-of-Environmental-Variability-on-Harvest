...
Climate projections for SST, chlorophyll-a, and near-surface wind speed are obtained from the CMIP6 archive, using the IPSL-CM6A-LR Earth system model. We use monthly outputs for two future scenarios---SSP2-4.5 (moderate) and SSP5-8.5 (high emissions)---and two time windows---mid-century (2041--2060) and end-of-century (2081--2100)---against a 1995--2014 historical baseline. Details of the delta-method projection approach are presented in Section \ref{projections}.
